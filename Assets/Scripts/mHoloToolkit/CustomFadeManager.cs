...
public class CustomFadeManager : Singleton<CustomFadeManager> {

    [Tooltip("If true, the CustomFadeManager will update the shared material. Useful for fading multiple cameras that each render different layers.")]
